...
- [x] Seguritización de API: CORS restrictivo (solo dominios autorizados), Rate Limiting (30 req/min/IP), Límite de Payload (máx 100 KB) y Headers de Seguridad OWASP (`X-Frame-Options`, `X-Content-Type-Options`)
