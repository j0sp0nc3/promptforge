  ...
  const _dict = {
    ...
    es: {
      ...
      workbench: {
        ...
        chipSafety: 'Salvaguardas',
        chipMcp: 'Contrato MCP',
        chipAntiLoop: 'Anti-Loop',
      ...
      analyzer: {
        ...
        safety: {
          ...
          assumesCapability: 'El prompt asume navegación, ejecución de código o datos en tiempo real sin declarar el contrato de herramientas (<tools>, function calling o MCP) que los habilita.',
          assumesCapabilitySugg: 'Declara las herramientas disponibles (ej. bloque <tools> con búsqueda/ejecución) o pide al modelo que indique si carece de la capacidad.',
      ...
      radar: {
        ...
        tabAll: '⚡ Todas',
        tabModels: '🧠 Modelos',
        tabAgents: '🤖 Agentes & Código',
        tabEvals: '🛡️ Evals & Seguridad',
        readSource: 'Ver publicación ↗',
        liveBadge: 'SOTA 2026',
        allCategories: 'Todas',
      ...
      adversarialLab: {
        ...
        runFuzzingBtn: 'Ejecutar Fuzzing Local (20 Mutaciones)',
    ...
    en: {
      ...
      workbench: {
        ...
        chipSafety: 'Guardrails',
        chipMcp: 'MCP Contract',
        chipAntiLoop: 'Anti-Loop Guard',
      ...
      patterns: {
        ...
        AP018: { name: 'Implicit instructions', desc: 'The prompt leaves too much to the model\'s interpretation without being explicit.', sugg: 'Be explicit about what you need. Instead of "Digital marketing" write "Explain the 5 most effective digital marketing strategies for B2B startups in 2026, with pros and cons for each".' },
      ...
      analyzer: {
        ...
        safety: {
          ...
          assumesCapability: 'The prompt assumes browsing, code execution or real-time data without declaring the tool contract (<tools>, function calling or MCP) that enables them.',
          assumesCapabilitySugg: 'Declare the available tools (e.g. a <tools> block with search/execution) or ask the model to state when it lacks the capability.',
      ...
      radar: {
        ...
        tabAll: '⚡ All',
        tabModels: '🧠 Models',
        tabAgents: '🤖 Agents & Code',
        tabEvals: '🛡️ Evals & Security',
        readSource: 'Read dispatch ↗',
        liveBadge: 'SOTA 2026',
        allCategories: 'All',
      ...
      adversarialLab: {
        ...
        runFuzzingBtn: 'Run Local Fuzzing (20 Mutations)',
