// ============================================================================
// Promptometer — Internationalization (i18n)
...
const I18n = (() => {
  const STORAGE_KEY = 'promptometer_lang';
  ...
  const _dict = {
    ...
    es: {
      ...
      sections: {
        ...
        improvedPrompt: 'Prompt Mejorado & Calibración Espectral',
        applyToEditor: 'Aplicar al Editor',
        copy: 'Copiar',
        findings: 'Hallazgos',
        suggestions: 'Sugerencias',
        constellationGraph: 'Mapa Constelación 8D',
        comparisonView: 'Resaltado por Dimensiones',
        actionShorten: '⚡ Acortar',
        actionCoT: '🧠 Agregar CoT',
        actionJSON: '📐 Forzar JSON',
        actionSafety: '🛡️ Guardrails',
        pillRole: 'Rol / Persona',
        pillContext: 'Contexto / Dominio',
        pillFormat: 'Esquema de Salida',
        pillReasoning: 'Razonamiento CoT',
        pillSafety: 'Seguridad / Guardrails',
        pillRobustness: 'Manejo de Errores',
      },
      ...
      report: {
        title: '📊 Reporte de Análisis — Promptometer',
        ...
        noPrompt: '(sin prompt)',
        footer: '*Reporte generado automáticamente por [Promptometer](https://promptometer.app) — Analizador de Prompts*',
      ...
      learn: {
        ...
        detailDimension: 'Dimensión',
        detailSuggestion: 'Sugerencia',
        ...
        subRadar: 'Radar',
        radarTitle: 'Radar IA — Creadores & Fuentes Gen AI',
        radarSubtitle: 'Directorio curado de investigadores, ingenieros y creadores clave que comparten avances de Prompt Engineering, Agentes y Generative AI.',
        suggestCreator: 'Sugerir Creador',
      },

      // ── LLM Models Directory & Benchmarks ─────────────────────────────
      models: {
        title: 'Directorio de Modelos LLM & Benchmarks',
        subtitle: 'Catálogo exhaustivo de modelos de frontera y pesos abiertos, telemetría de rendimiento y guías de prompting optimizadas.',
        podiumTitle: '🏆 Podio Top 3 de Modelos Líderes',
        filterAll: 'Todos',
        filterFrontier: 'Frontera',
        filterOpenWeights: 'Open Source',
        filterReasoning: 'Razonamiento',
        filterCoding: 'Código',
        searchPlaceholder: 'Buscar modelo por nombre, proveedor o arquitectura...',
        noResults: 'No se encontraron modelos que coincidan con los filtros.',
        arenaElo: 'LMSYS Arena ELO',
        mmluPro: 'MMLU-Pro',
        sweBench: 'SWE-bench',
        math500: 'MATH 500',
        humanEval: 'HumanEval',
        ...
        license: 'Licencia',
        pricing: 'Costo Inferencia',
        provider: 'Proveedor',
        viewSpecs: 'Ver Especificaciones & Guía',
        usePrompt: 'Cargar Prompt Optimizado',
        promptLoadedToast: '¡Prompt optimizado para {model} cargado en el editor!',
        modalTitle: 'Especificaciones Técnicas & Guía de Prompting',
        strengths: 'Fortalezas Clave',
        promptingStyle: 'Estilo de Prompting Recomendado',
        samplePromptTitle: 'Prompt Canónico de Ejemplo',
        officialDocs: 'Documentación Oficial',
        suggestModelBtn: 'Sugerir Modelo',
        observatoryBadge: 'Observatorio SOTA · Snapshot Agosto 2026',
        observatorySources: 'Fuentes de Benchmarks en Vivo:',
        modalSuggestTitle: 'Sugerir Nuevo Modelo LLM',
        modalSuggestDesc: 'Propón un nuevo modelo de frontera o de código abierto para incorporarlo al ranking con sus benchmarks y guía de prompting.',
        labelModelName: 'Nombre del Modelo (ej. DeepSeek-R1, Gemini 2.5)',
        labelModelProvider: 'Laboratorio / Creador (ej. DeepSeek, Anthropic, Meta)',
        labelModelType: 'Tipo de Modelo',
        labelModelBenchmarks: 'Benchmarks o Enlace al Paper/Release (opcional)',
        typeFrontier: 'Frontera / Propietario (API)',
        typeOpenWeights: 'Open Source / Pesos Abiertos',
        suggestSuccessToast: '¡Sugerencia de modelo enviada con éxito para revisión!',
      },
      ...
      radar: {
        ...
        labelName: 'Nombre / Organización',
        labelHandle: 'Handle / Enlace a Red Social',
        labelReason: '¿Por qué recomendarlo? (opcional)',
        placeholderName: 'Ej. Andrej Karpathy',
        placeholderHandle: 'Ej. @karpathy o https://x.com/karpathy',
        ...
        validationRequired: 'Por favor completa el nombre y el handle antes de enviar.',
        subCreators: 'Creadores AI',
        tickerPause: 'Pausar ticker',
        tickerPlay: 'Reanudar ticker',
        tickerPrev: 'Novedad anterior',
        tickerNext: 'Siguiente novedad',
        tickerViewAll: 'Ver todo',
        modalFeedTitle: '📡 Novedades del Radar IA',
        modalFeedDesc: 'Últimas publicaciones, papers y descubrimientos seleccionados de los principales creadores de Gen AI.',
        modalSearchPlaceholder: 'Buscar novedad por texto, autor o tema...',
        allCategories: 'Todas',
        searchPlaceholder: 'Buscar creador por nombre, @handle o rol...',
        catAll: 'Todos',
        catPrompting: 'Prompting',
        catArchitecture: 'Arquitectura',
        catAgents: 'Agentes',
        catSecurity: 'Seguridad',
        noResults: 'No se encontraron creadores que coincidan con la búsqueda.',
      ...
      leaderboard: {
        ...
        emptyCategory: 'No hay prompts en esta categoría todavía.',
        rejectedProfanity: 'Tu prompt fue rechazado por contener lenguaje ofensivo o inapropiado.',
        rejectedInjection: 'Tu prompt fue rechazado por contener un intento de inyección de prompt.',
        rejectedMalicious: 'Tu prompt fue rechazado por contener código potencialmente peligroso.',
        rejectedSpam: 'Tu prompt fue rechazado por anti-spam (espera 5 minutos entre publicaciones).',
        rejectedLowScore: 'Tu prompt necesita al menos {minScore}/100 para el ranking global.',
        rejectedDuplicate: 'Este prompt ya fue publicado recientemente.',
        cat_general: 'General',
        cat_código: 'Código',
        cat_agentes: 'Agentes',
        cat_RAG: 'RAG',
        cat_extracción: 'Extracción',
        cat_evaluación: 'Evaluación',
        cat_marketing: 'Marketing',
        cat_NLP: 'NLP',
        cat_traducción: 'Traducción',
        cat_salud: 'Salud',
      },
    ...
    en: {
      ...
      sections: {
        ...
        improvedPrompt: 'Improved Prompt & Spectral Calibration',
        applyToEditor: 'Apply to Editor',
        copy: 'Copy',
        findings: 'Findings',
        suggestions: 'Suggestions',
        constellationGraph: '8D Constellation Map',
        comparisonView: 'Dimension Highlighting',
        actionShorten: '⚡ Shorten',
        actionCoT: '🧠 Add CoT',
        actionJSON: '📐 Enforce JSON',
        actionSafety: '🛡️ Guardrails',
        pillRole: 'Role / Persona',
        pillContext: 'Context / Domain',
        pillFormat: 'Output Schema',
        pillReasoning: 'CoT Reasoning',
        pillSafety: 'Safety / Guardrails',
        pillRobustness: 'Error Handling',
      },
      ...
      report: {
        ...
        noPrompt: '(no prompt)',
        footer: '*Report automatically generated by [Promptometer](https://promptometer.app) — Prompt Analyzer*',
        datasetLabel: 'Score',
      ...
      learn: {
        ...
        subRadar: 'Radar',
        radarTitle: 'AI Radar — Creators & Gen AI Sources',
        radarSubtitle: 'Curated directory of top researchers, engineers, and creators sharing Prompt Engineering, Agents, and Gen AI insights.',
        suggestCreator: 'Suggest Creator',
      },

      // ── LLM Models Directory & Benchmarks ─────────────────────────────
      models: {
        title: 'LLM Models Directory & Benchmarks',
        subtitle: 'Comprehensive catalog of frontier and open-weights models, performance telemetry, and optimized prompting guides.',
        podiumTitle: '🏆 Top 3 Leading Models Podium',
        filterAll: 'All',
        filterFrontier: 'Frontier',
        filterOpenWeights: 'Open Source',
        filterReasoning: 'Reasoning',
        filterCoding: 'Coding',
        searchPlaceholder: 'Search model by name, provider, or architecture...',
        ...
        provider: 'Provider',
        viewSpecs: 'View Specs & Guide',
        usePrompt: 'Load Optimized Prompt',
        promptLoadedToast: 'Optimized prompt for {model} loaded into editor!',
        modalTitle: 'Technical Specs & Prompting Guide',
        strengths: 'Key Strengths',
        promptingStyle: 'Recommended Prompting Style',
        samplePromptTitle: 'Canonical Example Prompt',
        officialDocs: 'Official Documentation',
        suggestModelBtn: 'Suggest Model',
        observatoryBadge: 'SOTA Observatory · Snapshot August 2026',
        observatorySources: 'Live Benchmark Sources:',
        modalSuggestTitle: 'Suggest New LLM Model',
        modalSuggestDesc: 'Propose a new frontier or open-weights model to be added to the ranking with its benchmarks and prompting guide.',
        labelModelName: 'Model Name (e.g. DeepSeek-R1, Gemini 2.5)',
        labelModelProvider: 'Lab / Creator (e.g. DeepSeek, Anthropic, Meta)',
        labelModelType: 'Model Type',
        labelModelBenchmarks: 'Benchmarks or Paper/Release URL (optional)',
        typeFrontier: 'Frontier / Proprietary (API)',
        typeOpenWeights: 'Open Source / Open Weights',
        suggestSuccessToast: 'Model suggestion submitted successfully for review!',
      },

      radar: {
        title: 'AI Radar — Creators & Gen AI Sources',
        subtitle: 'Curated directory of top researchers, engineers, and creators sharing Prompt Engineering, Agents, and Gen AI insights.',
        suggestBtn: 'Suggest Creator',
        modalTitle: 'Suggest AI Creator / Account',
        modalDesc: 'Propose a social media profile or technical channel focused on Prompt Engineering or Gen AI for the community.',
        labelName: 'Name / Organization',
        labelHandle: 'Handle / Social Media Link',
        labelReason: 'Why recommend them? (optional)',
        placeholderName: 'e.g. Andrej Karpathy',
        placeholderHandle: 'e.g. @karpathy or https://x.com/karpathy',
        ...
        validationRequired: 'Please fill in the name and handle before submitting.',
        subCreators: 'AI Creators',
        tickerPause: 'Pause ticker',
        tickerPlay: 'Resume ticker',
        tickerPrev: 'Previous item',
        tickerNext: 'Next item',
        tickerViewAll: 'View all',
        modalFeedTitle: '📡 AI Radar Live Feed',
        modalFeedDesc: 'Latest posts, research papers, and discoveries curated from top Gen AI creators.',
        modalSearchPlaceholder: 'Search updates by text, author or tag...',
        allCategories: 'All',
        searchPlaceholder: 'Search creator by name, @handle, or role...',
        catAll: 'All',
        catPrompting: 'Prompting',
        catArchitecture: 'Architecture',
        catAgents: 'Agents',
        catSecurity: 'Security',
        noResults: 'No creators found matching your search.',
      ...
      leaderboard: {
        ...
        rejectedProfanity: 'Your prompt was rejected for containing offensive or inappropriate language.',
        rejectedInjection: 'Your prompt was rejected for containing a prompt injection attempt.',
        rejectedMalicious: 'Your prompt was rejected for containing potentially dangerous code.',
        rejectedSpam: 'Your prompt was rejected by anti-spam (wait 5 minutes between submissions).',
        rejectedLowScore: 'Your prompt needs at least {minScore}/100 for the global ranking.',
        rejectedDuplicate: 'This prompt was already published recently.',
        cat_general: 'General',
        cat_código: 'Code',
        cat_agentes: 'Agents',
        cat_RAG: 'RAG',
        cat_extracción: 'Extraction',
        cat_evaluación: 'Evaluation',
        cat_marketing: 'Marketing',
        cat_NLP: 'NLP',
        cat_traducción: 'Translation',
        cat_salud: 'Health',
      },
